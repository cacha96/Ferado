<?php
$vm_override_functions = JPATH_THEMES.DS.JFactory::getApplication()->getTemplate().DS."html/com_virtuemart/vm_functions.php";
...
<div class="productdetails-view productdetails">
    ...
    <div class="vm-product-container">
		...
		<div class="vm-product-details-container">
			...
			<div class="product_meta">
				...
				?>
				<span class="sku_wrapper">SKU: <span class="sku" ><?php echo $this->product->product_sku; ?></span>.</span>
				<span class="posted_in">Category: <?php echo $this->product->category_name; ?>.</span>
	...
	<div class="information_tabs">
	    ...
	    echo shopFunctionsF::renderVmSubLayout('default_relatedproducts',array('product'=>$this->product,'position'=>'related_products','class'=> 'product-related-products','customTitle' => true ));

		echo shopFunctionsF::renderVmSubLayout('efault_relatedrelated_categories',array('product'=>$this->product,'position'=>'related_categories','class'=> 'product-related-categories'));
		?>
