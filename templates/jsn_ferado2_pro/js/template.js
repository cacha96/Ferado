...
var SunBlank = {
	...
	{	
		(function($) {
			$('h1.counting-up > span').addClass('counter');
			$('.counter').counterUp({
                delay: 10,
                time: 1000
            });
		...
		(function($) {
			...
			//Toolbox wishlist RedShop
			if ($(".product_detail a.redshop-wishlist-link").length){
				$(".product_detail a.redshop-wishlist-link").each(function(){
					var title = $(this).text();
					$('<div/>', {
				        text: title,
				        class: 'wishlist-box'
